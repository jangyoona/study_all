		    ...
		    <div id="inputmain">
		        ...
		        <table>
		            ...
		            <tr>
		                ...
		                <input type="hidden" name="writer" value="<%= member.getMemberId()%>" style="width:580px" />
		                <%-- <input type="text" name="writer" value="<%= member.getMemberid()%>" style="width:580px" readonly /> --%>
		                <%= member.getMemberId() %>
		                </td>
		            </tr>
		            <tr>
